...
- **Audio sounds like OpenAI / Microsoft / etc., not Fish Audio:** Provider is being bypassed. Check Discord channel config — it may have its own `channels.discord.voice.tts.provider` override. Set it to `fish-audio-realtime`.
